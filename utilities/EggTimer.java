...
public class EggTimer extends TimerTask {
    ...
    /**
     * Creates a one-time EggTimer that 
     * starts right away and counts down from the
     ...
     *
     * The seconds left counter is decremented. 
     * If the EggTimer runs out the Timer
     * is stopped and forgotten.
     */
    ...
    /**
     * Fetch the seconds left. /** Fetch the seconds left.
     * 
    ...
    /**
     * Iterate through the list of tick listeners 
     * and notify each one that the timer
     * has ticked.
     */
